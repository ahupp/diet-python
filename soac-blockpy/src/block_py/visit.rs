...
pub trait VisitInstr<I: Instr>: Visit<I> {}
impl<T, I> VisitInstr<I> for T
where
    T: Visit<I> + ?Sized,
    I: Instr,
{
...
pub trait VisitTerm<I: Instr>: Visit<I> {}
impl<T, I> VisitTerm<I> for T
where
    T: Visit<I> + ?Sized,
    I: Instr,
{
...
pub trait VisitBlock<I: Instr>: Visit<I> {}
impl<T, I> VisitBlock<I> for T
where
    T: Visit<I> + ?Sized,
    I: Instr,
{
...
pub trait VisitFunction<P: BlockPyPass>: Visit<P::Expr> {}
impl<T, P> VisitFunction<P> for T
where
    T: Visit<P::Expr> + ?Sized,
    P: BlockPyPass,
{
}

pub trait VisitModule<P: BlockPyPass>: Visit<P::Expr> {}
impl<T, P> VisitModule<P> for T
where
    T: Visit<P::Expr> + ?Sized,
    P: BlockPyPass,
{
...
pub trait VisitMutInstr<I: Instr>: VisitMut<I> {}
impl<T, I> VisitMutInstr<I> for T
where
    T: VisitMut<I> + ?Sized,
    I: Instr,
{
...
pub trait VisitMutTerm<I: Instr>: VisitMut<I> {}
impl<T, I> VisitMutTerm<I> for T
where
    T: VisitMut<I> + ?Sized,
    I: Instr,
{
...
pub trait VisitMutBlock<I: Instr>: VisitMut<I> {}
impl<T, I> VisitMutBlock<I> for T
where
    T: VisitMut<I> + ?Sized,
    I: Instr,
{
...
pub trait VisitMutFunction<P: BlockPyPass>: VisitMut<P::Expr> {}
impl<T, P> VisitMutFunction<P> for T
where
    T: VisitMut<P::Expr> + ?Sized,
    P: BlockPyPass,
{
}

pub trait VisitMutModule<P: BlockPyPass>: VisitMut<P::Expr> {}
impl<T, P> VisitMutModule<P> for T
where
    T: VisitMut<P::Expr> + ?Sized,
    P: BlockPyPass,
{
