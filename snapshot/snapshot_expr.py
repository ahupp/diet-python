...
#             branch_table __dp_load_cell(_dp_cell__dp_pc) -> [_dp_genexpr_1_done, _dp_genexpr_1_dispatch_send_target_1, _dp_genexpr_1_dispatch_send_target_2] default _dp_genexpr_1_invalid
...
#             block _dp_genexpr_1_dispatch_send_target_2:
...
#             branch_table __dp_load_cell(_dp_cell__dp_pc) -> [_dp_genexpr_1_dispatch_throw_done, _dp_genexpr_1_dispatch_throw_target_1, _dp_genexpr_1_dispatch_throw_target_2] default _dp_genexpr_1_invalid
...
#                     raise _dp_resume_exc
#             block _dp_genexpr_1_dispatch_throw_target_2:
#                 jump _dp_genexpr_1_2
#     block _dp_genexpr_1_uncaught:
