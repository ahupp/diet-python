...
# function _dp_lambda_1(y) [kind=function, bind=_dp_lambda_1, target=local, qualname=<lambda>, display_name=<lambda>, entry_params=[y]]
#     block _dp_bb__dp_lambda_1_start:
#         return __dp_add(y, 1)

# function _dp_module_init() [kind=function, bind=_dp_module_init, target=module_global, qualname=_dp_module_init]
#     block _dp_bb__dp_module_init_start:
#         _dp_lambda_1 = __dp_def_fn("_dp_bb__dp_lambda_1_start", "<lambda>", "<lambda>", __dp_tuple("y"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"y"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT")))), __dp_globals(), __name__, None, None)
...
# function _dp_genexpr_1(_dp_iter_2) [kind=function, bind=_dp_genexpr_1, target=local, qualname=<genexpr>, display_name=<genexpr>, entry_params=[_dp_iter_2], local_cell_slots=[_dp_cell__dp_iter_2, _dp_cell__dp_iter_3, _dp_cell__dp_pc, _dp_cell__dp_tmp_4, _dp_cell__dp_yieldfrom, _dp_cell_i], cellvars=[_dp_iter_2->_dp_cell__dp_iter_2@param, _dp_iter_3->_dp_cell__dp_iter_3@deferred, _dp_tmp_4->_dp_cell__dp_tmp_4@deferred, i->_dp_cell_i@deferred], runtime_cells=[_dp_pc->_dp_cell__dp_pc@pc_unstarted, _dp_yieldfrom->_dp_cell__dp_yieldfrom@none]]
...
# function _dp_genexpr_1_resume(_dp_iter_2) [kind=generator, bind=_dp_genexpr_1_resume, target=local, qualname=<genexpr>, display_name=_dp_resume, entry_params=[_dp_self, _dp_send_value, _dp_resume_exc, _dp_cell__dp_iter_2, _dp_cell__dp_iter_3, _dp_cell__dp_tmp_4, _dp_cell_i, _dp_cell__dp_pc, _dp_cell__dp_yieldfrom], local_cell_slots=[_dp_cell__dp_iter_2, _dp_cell__dp_iter_3, _dp_cell__dp_pc, _dp_cell__dp_tmp_4, _dp_cell__dp_yieldfrom, _dp_cell_i], cellvars=[_dp_iter_2->_dp_cell__dp_iter_2@param, _dp_iter_3->_dp_cell__dp_iter_3@deferred, _dp_tmp_4->_dp_cell__dp_tmp_4@deferred, i->_dp_cell_i@deferred], runtime_cells=[_dp_pc->_dp_cell__dp_pc@pc_unstarted, _dp_yieldfrom->_dp_cell__dp_yieldfrom@none]]
...
# function _dp_module_init() [kind=function, bind=_dp_module_init, target=module_global, qualname=_dp_module_init]
#     block _dp_bb__dp_module_init_start:
#         _dp_genexpr_1 = __dp_def_fn("_dp_bb__dp_genexpr_1_factory", "<genexpr>", "<genexpr>", __dp_tuple("_dp_iter_2"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"_dp_iter_2"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT")))), __dp_globals(), __name__, None, None)
...
# function _dp_setcomp_3(_dp_iter_2) [kind=function, bind=_dp_setcomp_3, target=local, qualname=_dp_setcomp_3, display_name=<setcomp>, entry_params=[_dp_iter_2]]
...
# function _dp_module_init() [kind=function, bind=_dp_module_init, target=module_global, qualname=_dp_module_init]
#     block _dp_bb__dp_module_init_start:
#         _dp_setcomp_3 = __dp_def_fn("_dp_bb__dp_setcomp_3_start", "<setcomp>", "_dp_setcomp_3", __dp_tuple("_dp_iter_2"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"_dp_iter_2"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT")))), __dp_globals(), __name__, None, None)
...
# function _dp_dictcomp_3(_dp_iter_2) [kind=function, bind=_dp_dictcomp_3, target=local, qualname=_dp_dictcomp_3, display_name=<dictcomp>, entry_params=[_dp_iter_2]]
...
# function _dp_module_init() [kind=function, bind=_dp_module_init, target=module_global, qualname=_dp_module_init]
#     block _dp_bb__dp_module_init_start:
#         _dp_dictcomp_3 = __dp_def_fn("_dp_bb__dp_dictcomp_3_start", "<dictcomp>", "_dp_dictcomp_3", __dp_tuple("_dp_iter_2"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"_dp_iter_2"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT")))), __dp_globals(), __name__, None, None)
