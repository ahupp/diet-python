...
#         StoreName("x", 1)
#         StoreName("m", MakeFunction(0:0, Function, tuple_values(), NONE))
#         StoreName("__annotate_func__", MakeFunction(0:1, Function, tuple_values(__import__("soac.runtime", globals(), dict(), tuple_values("runtime"), 0)), NONE))
#         return NONE
...
#         StoreName("_dp_assign_index_6", "__qualname__")
#         SetItem(_dp_assign_obj_5, _dp_assign_index_6, _dp_assign_value_4)
#         StoreName("open", MakeFunction(0:0, Function, tuple_values("r", "utf8"), NONE))
#         return NONE
...
#     function_id: 0:3
#     block bb1:
#         StoreName("_dp_class_ns_Wrapper", MakeFunction(0:1, Function, tuple_values(), NONE))
#         StoreName("_dp_define_class_Wrapper", MakeFunction(0:2, Function, tuple_values(NONE), NONE))
...
#     function_id: 0:2
#     block bb1:
#         StoreName("_dp_class_ns_D", MakeFunction(0:0, Function, tuple_values(), NONE))
#         StoreName("_dp_define_class_D", MakeFunction(0:1, Function, tuple_values(NONE), NONE))
...
#     block bb1:
#         StoreName("x", "outer")
#         StoreName("_dp_class_ns_Inner", MakeFunction(0:0, Function, tuple_values(), NONE))
#         StoreName("_dp_define_class_Inner", MakeFunction(0:1, Function, tuple_values(NONE), NONE))
...
#         StoreName("_dp_assign_index_6", "__qualname__")
#         SetItem(_dp_assign_obj_5, _dp_assign_index_6, _dp_assign_value_4)
#         StoreName("f", MakeFunction(0:0, Function, tuple_values(), NONE))
#         return NONE
...
#     function_id: 0:3
#     block bb1:
#         StoreName("_dp_class_ns_X", MakeFunction(0:1, Function, tuple_values(), NONE))
#         StoreName("_dp_define_class_X", MakeFunction(0:2, Function, tuple_values(NONE), NONE))
...
#         StoreName("_dp_class_ns_B", MakeFunction(0:0, Function, tuple_values(), NONE))
#         StoreName("_dp_define_class_B", MakeFunction(0:1, Function, tuple_values(NONE), NONE))
...
#     function_id: 0:4
#     block bb1:
#         StoreName("_dp_class_ns_A", MakeFunction(0:2, Function, tuple_values(), NONE))
#         StoreName("_dp_define_class_A", MakeFunction(0:3, Function, tuple_values(NONE), NONE))
...
#     function_id: 0:5
#     block bb1:
#         StoreName("foo", MakeFunction(0:4, Function, tuple_values(), NONE))
#         return NONE
