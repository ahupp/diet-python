...
# function m(self) [kind=function, bind=m, target=class_namespace, qualname=C.m, entry_params=[self]]
...
# function open(self, mode: __dp_class_lookup_global(_dp_class_ns, "str", globals()) = "r", *, encoding: __dp_class_lookup_global(_dp_class_ns, "str", globals()) = "utf8") [kind=function, bind=open, target=class_namespace, qualname=Wrapper.open, entry_params=[mode, encoding], cellvars=[mode->_dp_cell_mode@param, encoding->_dp_cell_encoding@param]]
#     block _dp_bb_open_start:
#         return open(mode, encoding=encoding)

# function _dp_class_ns_Wrapper(_dp_class_ns, _dp_classcell_arg) [kind=function, bind=_dp_class_ns_Wrapper, target=local, qualname=_dp_class_ns_Wrapper, entry_params=[_dp_class_ns, _dp_classcell_arg], cellvars=[_dp_class_ns->_dp_cell__dp_class_ns@param, _dp_classcell_arg->_dp_cell__dp_classcell_arg@param]]
...
# function _dp_define_class_Wrapper(_dp_class_ns_fn, _dp_class_ns_outer, _dp_prepare_dict = None) [kind=function, bind=_dp_define_class_Wrapper, target=local, qualname=_dp_define_class_Wrapper, entry_params=[_dp_class_ns_fn, _dp_class_ns_outer, _dp_prepare_dict]]
...
# function _dp_class_ns_D(_dp_class_ns, _dp_classcell_arg) [kind=function, bind=_dp_class_ns_D, target=local, qualname=_dp_class_ns_D, entry_params=[_dp_class_ns, _dp_classcell_arg]]
...
# function _dp_define_class_D(_dp_class_ns_fn, _dp_class_ns_outer, _dp_prepare_dict = None) [kind=function, bind=_dp_define_class_D, target=local, qualname=_dp_define_class_D, entry_params=[_dp_class_ns_fn, _dp_class_ns_outer, _dp_prepare_dict]]
...
# function _dp_class_ns_Inner(_dp_class_ns, _dp_classcell_arg) [kind=function, bind=_dp_class_ns_Inner, target=local, qualname=outer.<locals>._dp_class_ns_Inner, entry_params=[_dp_class_ns, _dp_classcell_arg, _dp_cell_x], freevars=[x->_dp_cell_x@inherited], cellvars=[_dp_class_ns->_dp_cell__dp_class_ns@param, _dp_classcell_arg->_dp_cell__dp_classcell_arg@param]]
...
# function _dp_define_class_Inner(_dp_class_ns_fn, _dp_class_ns_outer, _dp_prepare_dict = None) [kind=function, bind=_dp_define_class_Inner, target=local, qualname=outer.<locals>._dp_define_class_Inner, entry_params=[_dp_class_ns_fn, _dp_class_ns_outer, _dp_prepare_dict]]
...
# function f(x) [kind=function, bind=f, target=class_namespace, qualname=X.f, entry_params=[x, _dp_classcell], freevars=[_dp_classcell->_dp_classcell@inherited], cellvars=[x->_dp_cell_x@param]]
#     block _dp_bb_f_start:
#         __dp_delattr(_dp_classcell, "cell_contents")
#         __dp_call_super(super, _dp_classcell, x)
#         return

# function _dp_class_ns_X(_dp_class_ns, _dp_classcell_arg) [kind=function, bind=_dp_class_ns_X, target=local, qualname=_dp_class_ns_X, entry_params=[_dp_class_ns, _dp_classcell_arg]]
...
# function _dp_define_class_X(_dp_class_ns_fn, _dp_class_ns_outer, _dp_prepare_dict = None) [kind=function, bind=_dp_define_class_X, target=local, qualname=_dp_define_class_X, entry_params=[_dp_class_ns_fn, _dp_class_ns_outer, _dp_prepare_dict]]
...
# function _dp_class_ns_B(_dp_class_ns, _dp_classcell_arg) [kind=function, bind=_dp_class_ns_B, target=local, qualname=A._dp_class_ns_B, entry_params=[_dp_class_ns, _dp_classcell_arg]]
...
# function _dp_define_class_B(_dp_class_ns_fn, _dp_class_ns_outer, _dp_prepare_dict = None) [kind=function, bind=_dp_define_class_B, target=local, qualname=A._dp_define_class_B, entry_params=[_dp_class_ns_fn, _dp_class_ns_outer, _dp_prepare_dict]]
#     block _dp_bb__dp_define_class_B_start:
#         _dp_class_ns = _dp_class_ns_outer
#         return __dp_create_class("B", _dp_class_ns_fn, __dp_tuple(), _dp_prepare_dict, False, 4, ())

# function _dp_class_ns_A(_dp_class_ns, _dp_classcell_arg) [kind=function, bind=_dp_class_ns_A, target=local, qualname=_dp_class_ns_A, entry_params=[_dp_class_ns, _dp_classcell_arg], cellvars=[_dp_class_ns->_dp_cell__dp_class_ns@param, _dp_classcell_arg->_dp_cell__dp_classcell_arg@param]]
...
# function _dp_define_class_A(_dp_class_ns_fn, _dp_class_ns_outer, _dp_prepare_dict = None) [kind=function, bind=_dp_define_class_A, target=local, qualname=_dp_define_class_A, entry_params=[_dp_class_ns_fn, _dp_class_ns_outer, _dp_prepare_dict]]
...
# function _dp_class_ns_B(_dp_class_ns, _dp_classcell_arg) [kind=function, bind=_dp_class_ns_B, target=local, qualname=foo.<locals>.A._dp_class_ns_B, entry_params=[_dp_class_ns, _dp_classcell_arg]]
#     block _dp_bb__dp_class_ns_B_start:
#         _dp_classcell = _dp_classcell_arg
#         __dp_setitem(__dp_load_deleted_name("_dp_class_ns", _dp_class_ns), "__module__", __name__)
...
# function _dp_define_class_B(_dp_class_ns_fn, _dp_class_ns_outer, _dp_prepare_dict = None) [kind=function, bind=_dp_define_class_B, target=local, qualname=foo.<locals>.A._dp_define_class_B, entry_params=[_dp_class_ns_fn, _dp_class_ns_outer, _dp_prepare_dict]]
#     block _dp_bb__dp_define_class_B_start:
#         _dp_class_ns = _dp_class_ns_outer
#         return __dp_create_class("B", _dp_class_ns_fn, __dp_tuple(), _dp_prepare_dict, False, 7, ())

# function _dp_class_ns_A(_dp_class_ns, _dp_classcell_arg) [kind=function, bind=_dp_class_ns_A, target=local, qualname=foo.<locals>._dp_class_ns_A, entry_params=[_dp_class_ns, _dp_classcell_arg]]
#     block _dp_bb__dp_class_ns_A_start:
#         _dp_classcell = _dp_classcell_arg
#         __dp_setitem(__dp_load_deleted_name("_dp_class_ns", _dp_class_ns), "__module__", __name__)
...
# function _dp_define_class_A(_dp_class_ns_fn, _dp_class_ns_outer, _dp_prepare_dict = None) [kind=function, bind=_dp_define_class_A, target=local, qualname=foo.<locals>._dp_define_class_A, entry_params=[_dp_class_ns_fn, _dp_class_ns_outer, _dp_prepare_dict]]
#     block _dp_bb__dp_define_class_A_start:
#         _dp_class_ns = _dp_class_ns_outer
