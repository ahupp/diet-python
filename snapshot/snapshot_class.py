...
#         __dp_setitem(_dp_class_ns, "m", __dp_make_function("_dp_bb_m_start", 0, "m", "C.m", __dp_tuple("self"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"self"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT")))), __dp_globals(), __name__, None, None))
...
#         __dp_setitem(_dp_class_ns, "open", __dp_make_function("_dp_bb_open_start", 0, "open", "Wrapper.open", __dp_tuple("mode", "encoding"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"self"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"mode"), __dp_NONE, __dp_decode_literal_bytes(b"r")), __dp_tuple(__dp_decode_literal_bytes(b"kw:encoding"), __dp_NONE, __dp_decode_literal_bytes(b"utf8"))), __dp_globals(), __name__, None, _dp_fn___annotate___open))
#         return
...
#     qualname: _dp_module_init
#     block _dp_bb__dp_module_init_start:
#         _dp_class_ns_Wrapper = __dp_make_function("_dp_bb__dp_class_ns_Wrapper_start", 1, "_dp_class_ns_Wrapper", "_dp_class_ns_Wrapper", __dp_tuple("_dp_class_ns", "_dp_classcell_arg"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_classcell_arg"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT")))), __dp_globals(), __name__, None, None)
#         _dp_define_class_Wrapper = __dp_make_function("_dp_bb__dp_define_class_Wrapper_start", 2, "_dp_define_class_Wrapper", "_dp_define_class_Wrapper", __dp_tuple("_dp_class_ns_fn", "_dp_class_ns_outer", "_dp_prepare_dict"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns_fn"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns_outer"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_prepare_dict"), __dp_NONE, __dp_NONE)), __dp_globals(), __name__, None, None)
...
#     qualname: _dp_module_init
#     block _dp_bb__dp_module_init_start:
#         _dp_class_ns_D = __dp_make_function("_dp_bb__dp_class_ns_D_start", 0, "_dp_class_ns_D", "_dp_class_ns_D", __dp_tuple("_dp_class_ns", "_dp_classcell_arg"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_classcell_arg"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT")))), __dp_globals(), __name__, None, None)
#         _dp_define_class_D = __dp_make_function("_dp_bb__dp_define_class_D_start", 1, "_dp_define_class_D", "_dp_define_class_D", __dp_tuple("_dp_class_ns_fn", "_dp_class_ns_outer", "_dp_prepare_dict"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns_fn"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns_outer"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_prepare_dict"), __dp_NONE, __dp_NONE)), __dp_globals(), __name__, None, None)
...
#         _dp_class_ns_Inner = __dp_make_function("_dp_bb__dp_class_ns_Inner_start", 0, "_dp_class_ns_Inner", "outer.<locals>._dp_class_ns_Inner", __dp_tuple("_dp_class_ns", "_dp_classcell_arg", __dp_tuple("_dp_cell_x", _dp_cell_x)), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_classcell_arg"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT")))), __dp_globals(), __name__, None, None)
#         _dp_define_class_Inner = __dp_make_function("_dp_bb__dp_define_class_Inner_start", 1, "_dp_define_class_Inner", "outer.<locals>._dp_define_class_Inner", __dp_tuple("_dp_class_ns_fn", "_dp_class_ns_outer", "_dp_prepare_dict"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns_fn"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns_outer"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_prepare_dict"), __dp_NONE, __dp_NONE)), __dp_globals(), __name__, None, None)
...
#     qualname: _dp_module_init
#     block _dp_bb__dp_module_init_start:
#         __dp_store_global(globals(), "outer", __dp_make_function("_dp_bb_outer_start", 2, "outer", "outer", __dp_tuple(), __dp_tuple(), __dp_globals(), __name__, None, None))
#         return
...
#         __dp_setitem(_dp_class_ns, "f", __dp_make_function("_dp_bb_f_start", 0, "f", "X.f", __dp_tuple("x", __dp_tuple("_dp_classcell", _dp_classcell)), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"x"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT")))), __dp_globals(), __name__, None, None))
#         return
...
#         _dp_define_class_X = __dp_make_function("_dp_bb__dp_define_class_X_start", 2, "_dp_define_class_X", "_dp_define_class_X", __dp_tuple("_dp_class_ns_fn", "_dp_class_ns_outer", "_dp_prepare_dict"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns_fn"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns_outer"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_prepare_dict"), __dp_NONE, __dp_NONE)), __dp_globals(), __name__, None, None)
...
#         _dp_class_ns_B = __dp_make_function("_dp_bb__dp_class_ns_B_start", 0, "_dp_class_ns_B", "A._dp_class_ns_B", __dp_tuple("_dp_class_ns", "_dp_classcell_arg"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_classcell_arg"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT")))), __dp_globals(), __name__, None, None)
#         _dp_define_class_B = __dp_make_function("_dp_bb__dp_define_class_B_start", 1, "_dp_define_class_B", "A._dp_define_class_B", __dp_tuple("_dp_class_ns_fn", "_dp_class_ns_outer", "_dp_prepare_dict"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns_fn"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns_outer"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_prepare_dict"), __dp_NONE, __dp_NONE)), __dp_globals(), __name__, None, None)
...
#     qualname: _dp_module_init
#     block _dp_bb__dp_module_init_start:
#         _dp_class_ns_A = __dp_make_function("_dp_bb__dp_class_ns_A_start", 2, "_dp_class_ns_A", "_dp_class_ns_A", __dp_tuple("_dp_class_ns", "_dp_classcell_arg"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_classcell_arg"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT")))), __dp_globals(), __name__, None, None)
#         _dp_define_class_A = __dp_make_function("_dp_bb__dp_define_class_A_start", 3, "_dp_define_class_A", "_dp_define_class_A", __dp_tuple("_dp_class_ns_fn", "_dp_class_ns_outer", "_dp_prepare_dict"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns_fn"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns_outer"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_prepare_dict"), __dp_NONE, __dp_NONE)), __dp_globals(), __name__, None, None)
...
#         _dp_class_ns_B = __dp_make_function("_dp_bb__dp_class_ns_B_start", 0, "_dp_class_ns_B", "foo.<locals>.A._dp_class_ns_B", __dp_tuple("_dp_class_ns", "_dp_classcell_arg"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_classcell_arg"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT")))), __dp_globals(), __name__, None, None)
...
#         _dp_class_ns_A = __dp_make_function("_dp_bb__dp_class_ns_A_start", 2, "_dp_class_ns_A", "foo.<locals>._dp_class_ns_A", __dp_tuple("_dp_class_ns", "_dp_classcell_arg"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_classcell_arg"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT")))), __dp_globals(), __name__, None, None)
#         _dp_define_class_A = __dp_make_function("_dp_bb__dp_define_class_A_start", 3, "_dp_define_class_A", "foo.<locals>._dp_define_class_A", __dp_tuple("_dp_class_ns_fn", "_dp_class_ns_outer", "_dp_prepare_dict"), __dp_tuple(__dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns_fn"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_class_ns_outer"), __dp_NONE, __dp_getattr(__dp__, __dp_decode_literal_bytes(b"NO_DEFAULT"))), __dp_tuple(__dp_decode_literal_bytes(b"_dp_prepare_dict"), __dp_NONE, __dp_NONE)), __dp_globals(), __name__, None, None)
...
#     qualname: _dp_module_init
#     block _dp_bb__dp_module_init_start:
#         __dp_store_global(globals(), "foo", __dp_make_function("_dp_bb_foo_start", 4, "foo", "foo", __dp_tuple(), __dp_tuple(), __dp_globals(), __name__, None, None))
#         return
