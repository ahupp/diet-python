...
use diet_python::fixture::{parse_fixture, render_fixture};
use diet_python::{ruff_ast_to_string, transform_str_to_ruff_with_options, Options};
...
fn main() -> Result<(), String> {
    ...
    if args.is_empty() {
        let root = PathBuf::from("src/transform");
