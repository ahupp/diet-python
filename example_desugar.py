...
def _dp_ns_A(_ns):
    ...
    def _mk___init__():
        ...
        def __init__(self):
            self.arr = list((1, 2, 3))
        __init__.__qualname__ = getattr(__dp__, "add")(getattr(__dp__, "getitem")(_ns, "__qualname__"), ".__init__")
        return __init__
    ...
    def _mk_c():
        ...
        def c(self, d):
            return add(d, 2)
        c.__qualname__ = getattr(__dp__, "add")(getattr(__dp__, "getitem")(_ns, "__qualname__"), ".c")
        return c
    _dp_tmp_5 = _mk_c()
...
def _class_A():
    ...
    meta, ns, kwds = getattr(__dp__, "prepare_class")("A", bases)
    _dp_ns_A(ns)
    cls = meta("A", bases, ns)
    return cls
A = _class_A()
